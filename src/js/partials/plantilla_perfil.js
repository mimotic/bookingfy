...
plantillas.perfil = '<div class="login_users">'
		...
		+ '<i class="demo-icon icon-user">&#xe82b;</i> <input data-validado="" id="reg_pass_old" type="password" name="" placeholder="Introduzca su contrase actual">'
		+ '<a id="actualizarUserData" href="#" class="rotate"><i class="demo-icon icon-user">&#xe833;</i> Actualizar Datos</a>'
		+ '<a id="cancelarModal" href="#"><i class="demo-icon icon-user">&#xe804;</i> Cancelar</a>'
		+ '</div></div>';
