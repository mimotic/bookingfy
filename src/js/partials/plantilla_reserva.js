...
plantillas.reserva = '<div id="inContentModal"><h2 class="text-center">{{nombre_pista}}</h2>'
			...
			+'<p id="activar-check-lus"><label><i class="demo-icon icon-user icon_lucero">&#xe84f;</i></label><strong>¿Necesitará luz?</strong> <input type="checkbox" name="checkedluz" value="luz" id="checkedluz"><p>'
