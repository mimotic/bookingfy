...
plantillas.perfil_admin = '<div class="login_users">'
		...
		+ '<div class="clear"></div>'
		+ '{{#ifCond rol}}'
		+ '<lable for="rolAdmin"><input type="checkbox" id="rolAdmin" name="rolAdmin" checked="checked">Permisos de Administrador</lable>'
		+ '{{else}}'
		+ '<lable for="rolAdmin"><input type="checkbox" id="rolAdmin" name="rolAdmin"> Permisos de Administrador</lable>'
		+ '{{/ifCond}}'
		+ '<div class="clear"></div>'
